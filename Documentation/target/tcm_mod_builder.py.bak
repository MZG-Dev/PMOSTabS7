...
#	proto_ident = "iSCSI"
	...
	input = eval(input("Would you like to add " + fabric_mod_name + " to drivers/target/Makefile..? [yes,no]: "))
	if input == "yes" or input == "y":
		tcm_mod_add_kbuild(tcm_dir, fabric_mod_name)

	input = eval(input("Would you like to add " + fabric_mod_name + " to drivers/target/Kconfig..? [yes,no]: "))
	if input == "yes" or input == "y":
